...
const { getMovies } = require('../../Movies/application/useCases/getMovies')

describe('getMovies test', () => {
  test('should resolve with all movies saved', async () => {
    const movies = await getMovies(LocalRepository)
